                ...
                {recettes.map((recette) => (
                    <div className="recette my-20 mx-10">
                        <img src={recette.strMealThumb} alt={recette.strMeal}
                             className="rounded-lg mx-auto block h-auto w-full lg:w-72 flex-none bg-cover h-24 border-4 border-amber-50"/>
                        <div className="relative px-4 -mt-16">
                            <div className="bg-white p-6 rounded-lg shadow-lg">
                                ...
                                <span
                                    ...
                                    <div
                                        className="ml-2 break-words text-gray-600 uppercase text-xs font-semibold tracking-wider">
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <button
                                        className="bg-indigo-600 hover:bg-indigo-400 text-white font-bold py-2 px-4 rounded"
